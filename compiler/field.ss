...
(library (field)
  ...
  ;; This value must match `MAX_JUBJUB_SCALAR` in the Compact runtime.
  ...
  ;; This value must match `MAX_SECP256K1_SCALAR` in the Compact runtime.
  ...
  (define (max-secp256r1-base)
    (1- (- (expt 2 256) (expt 2 224) (- (expt 2 192)) (- (expt 2 96)) 1)))
  (define-field-predicate secp256r1-base? max-secp256r1-base)

  ;; This value must match `MAX_SECP256R1_SCALAR` in the Compact runtime.
